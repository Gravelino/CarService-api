...
namespace Persistence.Migrations
{
    ...
    [Migration("20250320161749_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Models.Mechanic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Application.Models.MechanicService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Application.Models.VisitService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Application.Models.VisitServiceSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VisitServiceSchedules");
                });
            ...
            modelBuilder.Entity("Application.Models.MechanicService", b =>
                {
                    b.HasOne("Application.Models.Mechanic", "Mechanic")
                        .WithMany()
            ...
            modelBuilder.Entity("Application.Models.Service", b =>
                {
                    b.HasOne("Application.Models.ServiceCategory", "Category")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("Application.Models.VisitServiceSchedule", b =>
                {
                    ...
                    b.HasOne("Application.Models.VisitService", "VisitService")
                        .WithMany()
